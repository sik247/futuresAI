...
export default function SignalsClient({
  ...
  /* -- Signal badge pulse ------------------------------------------ */
  useEffect(() => {
    const badges = document.querySelectorAll("[data-signal-badge]");
    badges.forEach((el) => {
      gsap.to(el, {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      {/*  HERO                                                        */}
      {/* ============================================================ */}
      <section ref={heroRef} className="pt-32 pb-12 px-6 max-w-7xl mx-auto">
        <p className="font-mono text-xs tracking-[0.3em] text-zinc-500 uppercase mb-3">
          AI Signals
        </p>
