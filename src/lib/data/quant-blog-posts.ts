...
// Defensive sort at module load — every consumer (mobile, desktop, home,
// related-posts, sns) gets newest-first regardless of whether they re-sort.
// Module evaluation runs once per process, so this is a one-time mutation.
